...
<body>
    ...
    <main class="main">
        <div class="page_section">
            <div class="pageBtn">
                <form method="POST">
                    <span><button type="submit" name="buttonA" title="A타워입니다.">A</button></span>
                    <span><button type="submit" name="buttonB" title="B타워입니다.">B</button></span>
                    <span><button type="submit" name="buttonC" title="C타워입니다.">C</button></span>
                    <span><button type="submit" name="buttonD" title="D타워입니다.">D</button></span>
                    <span><button type="submit" name="buttonT" title="T타워입니다.">T</button></span>
                    <span><button type="submit" name="buttonP" title="P타워입니다.">P</button></span>
                    <span><button type="submit" name="buttonE" title="E타워입니다.">E</button></span>
                </form>
            </div>
        </div>
        ...
        <section class="phone_status">
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if (isset($_POST['buttonA'])) {
                    ...
                    $myVariable = "B";
                } elseif (isset($_POST['buttonC'])) {
                    $myVariable = "C";
                } elseif (isset($_POST['buttonD'])) {
                    $myVariable = "D";
                } elseif (isset($_POST['buttonT'])) {
                    $myVariable = "T";
                } elseif (isset($_POST['buttonP'])) {
                    $myVariable = "P";
                } elseif (isset($_POST['buttonE'])) {
                    $myVariable = "E";
                }
            }
            // 기본값 재설정
            $myVariable = isset($myVariable) ? $myVariable : "C";
